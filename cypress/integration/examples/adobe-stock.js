...
// this script get property values from meta tag.

describe('Retrieving attribute values', function() {
    it('Test Case - Retrieving Meta attribute property value, content', function() {
    ...
    it('Test case - Retrieving attribute value, data-content-id', () => {
        cy.visit('https://stock.adobe.com/');
        cy.get('.sc-BngTV').type('cambodia');
        cy.get('.sc-cqpYsc').click();
